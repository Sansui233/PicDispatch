...
namespace PicDispatch
{
    public partial class TrashWindow : Window
    {
        ...
        public TrashWindow(IEnumerable<TargetFolder> targets, MainViewModel mainViewModel)
        {
            InitializeComponent();
            _viewModel = new TrashViewModel(mainViewModel.FileActions, mainViewModel, targets);
